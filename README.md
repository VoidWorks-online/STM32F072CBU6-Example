...
工程位于 [`Keil`](./Keil) 目录，使用 Keil MDK-ARM V5 工程格式。

| 编号 | 示例 | 主要资源 | 功能说明 |
| --- | --- | --- | --- |
| 00 | [GPIO Blink](./Keil/00GPIOBlink) | PA0 | 每 500 ms 翻转一次 GPIO，功能与 CLion 版本一致 |
| 01 | [UART Log](./Keil/01UARTLog) | PA9 / USART1_TX、PA10 / USART1_RX | USART1 周期日志输出 |
| 02 | [I2C Scan](./Keil/02I2CScan) | PB6 / I2C1_SCL、PB7 / I2C1_SDA、PA9 / USART1_TX | I2C 7 位地址扫描 |
| 03 | [SPI Basic](./Keil/03SPIBasic) | PA5 / SPI1_SCK、PA6 / SPI1_MISO、PA7 / SPI1_MOSI、PA9 / USART1_TX | SPI1 全双工回环测试 |
| 04 | [ADC Basic](./Keil/04ADCBasic) | PA0 / ADC_IN0、PA9 / USART1_TX | 12 位 ADC 采样与电压换算 |
| 05 | [CAN Basic](./Keil/05CANBasic) | PA11 / CAN_RX、PA12 / CAN_TX、PA9 / USART1_TX | bxCAN 标准帧内部回环测试 |
| 06 | [PWM Basic](./Keil/06PWMBasic) | PA8 / TIM1_CH1、PA0 / TIM2_CH1 | 两路约 1 kHz、50% 占空比 PWM 输出 |
| 07 | [USB CDC](./Keil/07USBCDC) | PA11 / USB_DM、PA12 / USB_DP | USB CDC 虚拟串口非阻塞回显，功能与 CLion 版本一致 |
| 08 | [DAC Basic](./Keil/08DACBasic) | PA4 / DAC_OUT1、PA9 / USART1_TX | 软件锯齿波输出 |

工程入口位于各示例的 `MDK-ARM/*.uvprojx`，例如 [`Keil/00GPIOBlink/MDK-ARM/00GPIOBlink.uvprojx`](./Keil/00GPIOBlink/MDK-ARM/00GPIOBlink.uvprojx)。
